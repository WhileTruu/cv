...
var author$project$Main$createDateRangeText = F2(
	function (from, maybeTo) {
		var monthAndYearToString = function (_n0) {
			var year = _n0.year;
			var month = _n0.month;
			return author$project$Main$monthToString(month) + (' ' + elm$core$String$fromInt(year));
		};
		return _Utils_ap(
			...
			A2(
				...
				'present',
				A2(elm$core$Maybe$map, monthAndYearToString, maybeTo)));
	});
...
var author$project$Main$experienceCard = function (_n0) {
	var attributes = _n0.attributes;
	var location = _n0.location;
	var speciality = _n0.speciality;
	var from = _n0.from;
	var maybeTo = _n0.maybeTo;
	return A2(
		elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('experience-card')
				]),
			attributes),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(author$project$Main$createDateRangeText, from, maybeTo))
					]))
			]));
};
var elm$time$Time$Jun = {$: 'Jun'};
var elm$time$Time$Sep = {$: 'Sep'};
var author$project$Main$kuressaareGymnasiumEducationExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--kuressaare-gymnasium light-color')
		]),
	from: {month: elm$time$Time$Sep, year: 2008},
	location: 'Kuressaare Gymnasium',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Jun, year: 2011}),
	speciality: 'Secondary Education'
};
var elm$time$Time$Feb = {$: 'Feb'};
var author$project$Main$maritimeAcademyEducationExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--maritime-academy')
		]),
	from: {month: elm$time$Time$Sep, year: 2011},
	location: 'Estonian Maritime Academy',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Feb, year: 2014}),
	speciality: 'Navigation Officer'
};
var author$project$Main$talTechEducationExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--tal-tech light-color')
		]),
	from: {month: elm$time$Time$Sep, year: 2014},
	location: 'Tallinn University of Technology',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Jun, year: 2017}),
	speciality: 'Informatics'
};
var author$project$Main$text = {
	...
	skillsList: _List_fromArray(
		['JavaScript', 'Elm', 'React', 'AngularJS', 'Docker', 'Python', 'Java', 'SQL', 'Linux', 'Unix'])
};
var elm$html$Html$h2 = _VirtualDom_node('h2');
var elm$html$Html$section = _VirtualDom_node('section');
var author$project$Main$educationView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('experience-cards')
				]),
			_List_fromArray(
				[
					author$project$Main$experienceCard(author$project$Main$talTechEducationExperience),
					author$project$Main$experienceCard(author$project$Main$maritimeAcademyEducationExperience),
					author$project$Main$experienceCard(author$project$Main$kuressaareGymnasiumEducationExperience)
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.additionalEducationInfo)
				]))
		]));
...
var author$project$Main$emailLink = A2(
	elm$html$Html$a,
	_List_fromArray(
		[
			elm$html$Html$Attributes$href('mailto:' + author$project$Main$text.emailAddress)
		]),
	_List_fromArray(
		[
			elm$html$Html$text(author$project$Main$text.emailAddress)
		]));
...
var author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.myName)
				])),
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					A2(elm$core$String$join, ', ', author$project$Main$text.skillsList))
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.skillsDescription)
				]))
		]));
var author$project$Main$projectsView = A2(
	elm$html$Html$section,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('You can check out my github at '),
					A2(
					elm$html$Html$a,
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://github.com/WhileTruu')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('https://github.com/WhileTruu')
						])),
					elm$html$Html$text('.'),
					A2(
					elm$html$Html$p,
					...
					_List_fromArray(
						[
							elm$html$Html$text('A few projects I have outlined below.')
						]))
				])),
			A2(
			elm$html$Html$h3,
			...
			_List_fromArray(
				[
					elm$html$Html$text('Salmefelt')
				])),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://www.salmefelt.com')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('https://www.salmefelt.com')
				])),
			elm$html$Html$text(', '),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://github.com/WhileTruu/salmefelt')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('https://github.com/WhileTruu/salmefelt')
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.salmefelt)
				])),
			A2(
			elm$html$Html$h3,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('Peers Against Humanity')
				])),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://github.com/WhileTruu/peers-against-humanity-frontend')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('https://github.com/WhileTruu/peers-against-humanity-frontend')
				])),
			elm$html$Html$text(', '),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://github.com/WhileTruu/peers-against-humanity-backend')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('https://github.com/WhileTruu/peers-against-humanity-backend')
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.peersAgainstHumanity)
				])),
			A2(
			elm$html$Html$h3,
			_List_Nil,
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://github.com/WhileTruu/cv')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('https://github.com/WhileTruu/cv')
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('This very page is also a tiny elm app. :)')
				]))
		]));
var author$project$Main$talTechJavaWorkExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--tal-tech light-color')
		]),
	from: {month: elm$time$Time$Feb, year: 2016},
	location: 'Tallinn University of Technology',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Jun, year: 2016}),
	speciality: 'Teacher\'s assistant: Main Course of Programming in Java'
};
var elm$time$Time$Jan = {$: 'Jan'};
var author$project$Main$talTechPythonWorkExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--tal-tech light-color')
		]),
	from: {month: elm$time$Time$Sep, year: 2016},
	location: 'Tallinn University of Technology',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Jan, year: 2017}),
	speciality: 'Teacher’s assistant: Programming in Python for advanced students'
};
var elm$time$Time$Nov = {$: 'Nov'};
var author$project$Main$tallinkWorkExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--tallink')
		]),
	from: {month: elm$time$Time$Nov, year: 2017},
	location: 'Tallink',
	maybeTo: elm$core$Maybe$Nothing,
	speciality: 'Frontend developer'
};
var elm$time$Time$Aug = {$: 'Aug'};
var elm$time$Time$Jul = {$: 'Jul'};
var author$project$Main$transferWiseWorkExperience = {
	attributes: _List_fromArray(
		[
			elm$html$Html$Attributes$class('experience-card--transferwise light-color')
		]),
	from: {month: elm$time$Time$Jul, year: 2016},
	location: 'TransferWise',
	maybeTo: elm$core$Maybe$Just(
		{month: elm$time$Time$Aug, year: 2016}),
	speciality: 'Internship Bootcamp'
};
var author$project$Main$workExperienceView = A2(
	elm$html$Html$section,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					author$project$Main$experienceCard(author$project$Main$tallinkWorkExperience),
					author$project$Main$experienceCard(author$project$Main$talTechPythonWorkExperience),
					author$project$Main$experienceCard(author$project$Main$transferWiseWorkExperience),
					author$project$Main$experienceCard(author$project$Main$talTechJavaWorkExperience)
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.additionalTalTechWorkInfo)
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.additionalTransferwiseWorkInfo)
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Main$text.additionalTallinkWorkInfo)
				]))
		]));
	...
	return {
		body: _List_fromArray(
			[
				...
				author$project$Main$educationView,
				author$project$Main$workExperienceView,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(author$project$Main$text.email + '('),
								author$project$Main$emailLink,
								elm$html$Html$text(').')
							]))
					]))
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"msg","aliases":{},"unions":{}}})}});}(this));